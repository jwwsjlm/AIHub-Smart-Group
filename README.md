...
桌面端面板使用左右双栏：左侧用于检测、推荐和密钥切换，右侧通过“设置 / 日志”标签切换内容。两栏分别滚动，面板不会因为打开设置或查看大量日志而超出屏幕顶部。脚本会记住最后打开的“设置”或“日志”标签。窄屏设备会自动改为纵向单列，主内容、设置和日志按实际内容高度依次排列，并在面板内部统一滚动，避免设置或日志遮挡上方操作区。
